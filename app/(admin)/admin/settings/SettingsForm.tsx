...
export default function AdminSettingsPage({ securityStatus }: SettingsFormProps) {
      ...
      <div className="card space-y-4">
        ...
        <div className="space-y-3 text-sm">
          {[
            ...
            { label: "Anthropic API key", value: securityStatus.hasAnthropicKey ? "Configured" : "Not set", status: securityStatus.hasAnthropicKey ? "ok" : (securityStatus.hasOpenRouterKey ? "info" : "warn") },
            { label: "OpenRouter API key", value: securityStatus.hasOpenRouterKey ? "Configured" : "Not set", status: securityStatus.hasOpenRouterKey ? "ok" : (securityStatus.hasAnthropicKey ? "info" : "warn") },
